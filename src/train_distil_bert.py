...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train and evaluate the DistilBERT classifier.")
    parser.add_argument(
        "--save-model",
        action="store_true",
    ...
    parser.add_argument(
        "--model-dir",
        default=str(MODELS_DIR / "distilbert_binary_classifier"),
...
def evaluate_bert_model(trainer: Trainer, test_ds: Dataset, val_ds: Dataset) -> None:
    """Evaluate DistilBert model performance"""
